...
/**
 * Created by Muhammed Faruk KOSE on 2.05.2018.
 */
...
public class Incoming extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(userid==0){
            Intent gec = new Intent(Incoming.this, Login.class);
            startActivity(gec);
        }
        else {
            listView=(ListView) findViewById(R.id.s_games_2);
            games=new ArrayList<>();
    ...
    class getgames extends AsyncTask<String,Void,String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                String results = run(JSON_URL_getgame+fid+"/"+userid);
        ...
        protected void onPostExecute(String s) {
            ...
            adapter = new gameCustomAdapter(Incoming.this, games, getApplicationContext());
