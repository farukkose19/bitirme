...
public class fragmentPackage2 extends ListFragment {
    ...
    public static fragmentPackage2 newInstance( int jsonword) {

        fragmentPackage2 f = new fragmentPackage2();
        Bundle b = new Bundle();
